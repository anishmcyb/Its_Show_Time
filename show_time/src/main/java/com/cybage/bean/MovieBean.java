...
public class MovieBean {
      ...
      public MovieBean(int movieId, String movieName, String city, String language, String genre, int duration,
                  String releaseDate, double price, String posterUrl, String director, String directorUrl,
                  String description) {
            super();
      ...
      public String toString() {
            return "MovieBean [movieId=" + movieId + ", movieName=" + movieName + ", city=" + city + ", language="
                        ...
                        + price + ", posterUrl=" + posterUrl + ", director=" + director + ", directorUrl=" + directorUrl
